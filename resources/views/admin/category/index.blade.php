...
@section('page_title', __('messages.category'))
                    ...
                    <div class="card m-b-30">
                        <div class="card-header">
                            <div class="card-header-actions">
                                ...
                                <button class="btn btn-success btn-save float-right" title="Add " data-toggle="modal" data-target="#category_add_modal" data-id="'.$data->id.'">{{__('messages.add') }}</button>
                                  @endif
                            </div>
                        </div>
                        <div class="card-body">
